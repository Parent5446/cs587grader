...
namespace CS587Grader\AccountBundle\Controller;
 ...
 *
 * @package CS587Grader\AccountBundle\Controller
 */
class RepositorySelectionController extends Controller
{
	...
	public function indexAction( Request $request ) {
		...
		// Otherwise, show form
		return $this->render(
			'CS587GraderAccountBundle:RepositorySelection:index.html.twig',
